...
from tensorflow.keras.layers import (Layer, Dense, Activation, add as tfk_add)
...
class ResNetLayer(Layer):
    ...
    .. warning::
        ...
        which should be avoided and replaced by the most recent ResNetLayer class (`from leap_net import ResNetLayer`) 
